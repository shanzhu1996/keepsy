  ...
  return (
    <div>
      ...
      {student.billing_enabled ? (
        <div className="mt-5 pt-4 keepsy-rise keepsy-rise-3" style={{ borderTop: "1px solid var(--line-subtle)" }}>
      ...
      {/* Messages */}
      <div className="mt-5 pt-4 keepsy-rise keepsy-rise-4" style={{ borderTop: "1px solid var(--line-subtle)" }}>
        <StudentMessages
      ...
      {/* Payments */}
      <div className="mt-5 pt-4 mb-8" style={{ borderTop: "1px solid var(--line-subtle)" }}>
